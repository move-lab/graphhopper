...
ENV JAVA_OPTS "-server -Xconcurrentio -Xmx24G -Xms24G -XX:+UseG1GC -Ddw.server.applicationConnectors[0].bindHost=0.0.0.0 -Ddw.server.applicationConnectors[0].port=8989"
