...
ENV JAVA_OPTS "-server -Xconcurrentio -Xmx20G -Xms20G -XX:+UseG1GC -Ddw.server.applicationConnectors[0].bindHost=0.0.0.0 -Ddw.server.applicationConnectors[0].port=8989"
